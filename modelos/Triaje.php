...
Class Triaje
{
	...
	{
		$sql2="UPDATE atencion set estado='Preconsulta' WHERE idatencion='$idatencion'";
		...
		VALUES ('$idatencion','$presion_arterial','$temperatura','$frecuencia_respiratoria','$frecuencia_cardiaca','$saturacion','$peso','$talla','$imc','Preconsulta')";
