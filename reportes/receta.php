...
<body>
  <table width="50%" border="1">
      <tr>
        <td colspan="3"><center><h3><b>CONSULTAS MINECO</b></h3></center></td>
      </tr>
      <tr>
        <td colspan="3"><center><h3><b>RECETA</b></h3></center></td>
      </tr>
      <tr>
        <td colspan="3"><center><img src="../public/img/MINECO-02.png" width="300px" heigth="200px"></center></td>
      </tr>
      <tr>
      ...
      <tr>
        <td colspan="3" style="background-color:#0b2a4a;"><center><h4>Detalle de Receta</h4></center></td>
      </tr>
      <tr>
        <td colspan="3">
          <table width="100%" border="1">
            <tr style="background-color:#0b2a4a;">
              <th>Medicamento</th>
              <th>Presentación</th>
              <th>Dosis</th>
              <th>Duración</th>
