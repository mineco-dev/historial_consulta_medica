                        ...
                        <form name="formulario" id="formulario" method="POST">
                           <div class="table-responsive">
                             <table class="table table-bordered">
                               <tr>
                                 <th style="background-color:#A9D0F5;">Paciente</th>
                                 <td><span id="paciente">Paciente</span></td>
                                  <th style="background-color:#A9D0F5;">DNI</th>
                                 <td><span id="dni">Paciente</span></td>
                                  <th style="background-color:#A9D0F5;">Edad</th>
                                 <td><span id="edad">Paciente</span></td>
                                 <th style="background-color:#A9D0F5;">Servicio</th>
                                 <td><span id="servicio">Servicio</span></td>
                                 <th style="background-color:#A9D0F5;">Especialista</th>
                               ...
                               <div class="panel panel-primary">
                                 <div class="panel-body">
                                  ...
                                  <div class="form-group col-lg-2 col-md-2 col-sm-2 col-xs-12">
                                    ...
                                    <input type="number" class="form-control" name="tiempo_enfermedad" id="tiempo_enfermedad" maxlength="30" required>
                                  </div>
